...
public class PaddleOptions
{
     ...
     * other practical reason to set it to true. 
     */
     ...
     * about the size of the points-to sets computed. 
     */
